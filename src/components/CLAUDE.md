...
- **InteractiveCanvasComponent.tsx**: 核心画布交互组件
- **Toolbar.tsx**: 工具栏组件
...
export { default as InteractiveCanvasComponent } from './InteractiveCanvasComponent';
...
- **InteractiveCanvasComponent.stories.tsx**: 画布组件故事
...
### Q: 如何添加新的绘图工具？
A: 创建新的工具组件，然后在 `InteractiveCanvasComponent` 中添加对应的工具处理逻辑。
...
- `InteractiveCanvasComponent.tsx` - 交互式画布（主要功能）
...
- `PropertyPanel.stories.tsx` - 属性面板故事
- `InteractiveCanvasComponent.stories.tsx` - 画布故事

## 变更记录 (Changelog)

- **2025-12-03**: 创建组件模块文档，定义组件结构和接口
- **2025-12-03**: 完成核心画布组件分析，包括 InteractiveCanvasComponent