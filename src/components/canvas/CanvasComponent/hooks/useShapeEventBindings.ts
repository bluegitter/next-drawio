...
export const useShapeEventBindings = ({
  ...
  }, [addConnectorNodeAt, beginEditText, draggingHandle, handleShapeMouseDown, hideConnectorHandles, hidePorts, hideResizeHandles, hideCornerHandles, isConnecting, selectedIds, shapes, showConnectorHandles, showPorts, showResizeHandles, showCornerHandles, showTextSelection, hideTextSelection]);
};
