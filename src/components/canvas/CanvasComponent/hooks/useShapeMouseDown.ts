...
export const useShapeMouseDown = ({
  ...
  }, [connectShapes, connectionStart, connectionStartPort, getPointerPosition, isConnecting, isLineConnected, onShapeSelect, selectedIds, setDragStart, setIsDragging, setSelectedIds, shapes, startConnection]);
};
