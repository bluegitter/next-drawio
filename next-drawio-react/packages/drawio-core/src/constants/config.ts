...
export const CONFIG = {
  ...
  APP: {
    ...
    BUILD_NUMBER: (typeof process !== 'undefined' && process.env?.BUILD_NUMBER) || 'dev',
    GIT_COMMIT: (typeof process !== 'undefined' && process.env?.GIT_COMMIT) || 'unknown',
  ...
  // 网络配置
  NETWORK: {
    API_BASE_URL: (typeof process !== 'undefined' && process.env?.NEXT_PUBLIC_API_URL) || '/api',
    WS_URL: (typeof process !== 'undefined' && process.env?.NEXT_PUBLIC_WS_URL) || '',
    CDN_URL: (typeof process !== 'undefined' && process.env?.NEXT_PUBLIC_CDN_URL) || '',
  ...
  LOGGING: {
    ...
    CONSOLE: (typeof process === 'undefined' || process.env?.NODE_ENV) !== 'production',
    FILE: (typeof process !== 'undefined' && process.env?.NODE_ENV) === 'production',
    REMOTE: (typeof process !== 'undefined' && process.env?.NODE_ENV) === 'production',
  ...
  PLUGINS: {
    ENABLED: true,
    AUTO_LOAD: true,
    SAFE_MODE: (typeof process !== 'undefined' && process.env?.NODE_ENV) === 'production',
  ...
  // 开发配置
  DEVELOPMENT: {
    HOT_RELOAD: (typeof process !== 'undefined' && process.env?.NODE_ENV) === 'development',
    SOURCE_MAPS: (typeof process !== 'undefined' && process.env?.NODE_ENV) === 'development',
    DEBUG_TOOLS: (typeof process !== 'undefined' && process.env?.NODE_ENV) === 'development',
  ...
  FEATURES: {
    EXPERIMENTAL: {
      WEBGL_RENDERER: (typeof process !== 'undefined' && process.env?.FEATURE_WEBGL) === 'true',
      AI_TOOLS: (typeof process !== 'undefined' && process.env?.FEATURE_AI) === 'true',
      COLLABORATION: (typeof process !== 'undefined' && process.env?.FEATURE_COLLAB) === 'true',
      REAL_TIME_SYNC: (typeof process !== 'undefined' && process.env?.FEATURE_SYNC) === 'true',
    },
